<div class='container'>
	...
	<?php if( have_rows('home_columns_row') ): $i=true; 
		...
		<div class="col-sm-<?php echo $col_width ?> text-center flex-col flex-mid">
		  <div class="home-column hc1" style="background-image:url(<?php echo $col1['column_image_1']['sizes']['tablet-crop']; ?>);">
		  	<div class='overlay'>
			  ...
			  <a href="<?php echo $col1['column_link_1']; ?>">
			  	<h3 class="entry-title"><?php echo $col1['column_title_1']; ?></h3>
			  </a>
			</div>
		  </div>
		</div>
		...
		<div class="col-sm-<?php echo $col_width ?> text-center flex-col flex-mid">
		  <div class="home-column hc1" style="background-image:url(<?php echo $col2['column_image_2']['sizes']['tablet-crop']; ?>);">
		  	<div class='overlay'>
			  <div class="entry-content">
			  ...
			  <a href="<?php echo $col2['column_link_2']; ?>">
			  	<h3 class="entry-title"><?php echo $col2['column_title_2']; ?></h3>
			  </a>
			</div>
		  </div>
		</div>
		...
		<?php if($col_width!=='6'): ?>
		<div class="col-sm-<?php echo $col_width ?> text-center flex-col flex-mid">
		  <div class="home-column hc1" style="background-image:url(<?php echo $col3['column_image_3']['sizes']['tablet-crop']; ?>);">
		  	<div class='overlay'>
			  <div class="entry-content">
			  ...
			  <a href="<?php echo $col3['column_link_3']; ?>">
			  	<h3 class="entry-title"><?php echo $col3['column_title_3']; ?></h3>
			  </a>
			</div>
		  </div>
		</div>
		...
		<?php if($col_width=='3'): ?>
		<div class="col-sm-<?php echo $col_width ?> text-center flex-col flex-mid">
		  <div class="home-column hc1" style="background-image:url(<?php echo $col4['column_image_4']['sizes']['tablet-crop']; ?>);">
		  	<div class='overlay'>
			  <div class="entry-content">
			  ...
			  <a href="<?php echo $col4['column_link_4']; ?>">
			  	<h3 class="entry-title"><?php echo $col4['column_title_4']; ?></h3>
			  </a>
			</div>
		  </div>
		</div>
